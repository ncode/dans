...
require 'actions/setup-node@v4' 'install the frontend build toolchain'
require 'node-version: 24' 'use the supported Node.js release'
require 'cache: npm' 'cache frontend dependencies'
require 'cache-dependency-path: web/package-lock.json' 'key frontend dependency caching to the lockfile'
